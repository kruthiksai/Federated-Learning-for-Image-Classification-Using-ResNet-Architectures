...
Outputs
The program outputs various performance graphs showing the accuracy and loss over different rounds of training for both ResNet-18 and ResNet-50 models.
These output graphs are stored in the artifacts folder, along with confusion matrices and classification reports generated during the evaluations.
